...
Revision ID: aa815902db79
Revises: eca555e757c9
Create Date: 2025-12-06 13:06:56.526783
...
revision: str = 'aa815902db79'
down_revision: Union[str, Sequence[str], None] = 'eca555e757c9'
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['subscribed_to_id'], ['accounts.id'], name=op.f('subscriptions_subscribed_to_id_fkey')),
    sa.ForeignKeyConstraint(['subscriber_id'], ['accounts.id'], name=op.f('subscriptions_subscriber_id_fkey')),
    sa.PrimaryKeyConstraint('subscriber_id', 'subscribed_to_id', name=op.f('subscriptions_pkey'))
    )
